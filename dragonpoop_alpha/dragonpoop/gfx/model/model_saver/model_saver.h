...
namespace dragonpoop
{
    ...
    protected:
        ...
        //ctor
        model_saver( core *c, dptaskpool_writelock *tp, model_ref *m, std::string *fname );
        //generate read lock
    ...
    public:
        ...
        bool isRunning( void );
        //save model to file
        static model_saver *saveFile( core *c, dptaskpool_writelock *tp, model_ref *m, const char *fname );
