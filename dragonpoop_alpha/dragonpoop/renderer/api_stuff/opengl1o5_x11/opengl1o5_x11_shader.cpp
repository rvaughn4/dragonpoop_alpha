...
namespace dragonpoop
{
    ...
    bool opengl1o5_x11_shader::render( render_api_context_writelock *ctx, render_api_texture_ref *t0, render_api_texture_ref *t1, render_api_indexbuffer_ref *ib, render_api_vertexbuffer_ref *vb, dpmatrix *m, float alpha )
    {
        ...
        return this->_render( ctx, gltex0, gltex1, bib, bvb, m, alpha );
    }
    
    //render gl
    bool opengl1o5_x11_shader::_render( render_api_context_writelock *ctx, unsigned int t0, unsigned int t1, dpindex_buffer *ib, dpvertex_buffer *vb, dpmatrix *m, float alpha )
    {
        return 1;
    }
