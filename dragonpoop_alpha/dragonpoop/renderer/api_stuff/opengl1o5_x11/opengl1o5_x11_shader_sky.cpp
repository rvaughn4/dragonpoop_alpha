...
namespace dragonpoop
{
    ...
    //ctor
    opengl1o5_x11_shader_sky::opengl1o5_x11_shader_sky( render_api_context_writelock *c, dpmutex_master *mm, opengl1o5_x11_functions *gl ) : opengl1o5_x11_shader( c, mm, gl )
    {
        this->gl = gl;
    }
    ...
    //render gl
    bool opengl1o5_x11_shader_sky::_render( render_api_context_writelock *ctx, unsigned int t0, unsigned int t1, dpindex_buffer *ib, dpvertex_buffer *vb, dpmatrix *m, float alpha, dpmatrix *m_world, float r, float g, float b, unsigned int vbo )
    {
