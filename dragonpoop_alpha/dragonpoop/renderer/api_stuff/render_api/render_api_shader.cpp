...
namespace dragonpoop
{
    ...
    //ctor
    render_api_shader::render_api_shader( render_api_context_writelock *c, dpmutex_master *mm ) : shared_obj( mm )
    {
    ...
    //render vb
    bool render_api_shader::render( render_api_context_writelock *ctx, render_api_texture_ref *t0, render_api_texture_ref *t1, render_api_indexbuffer_ref *ib, render_api_vertexbuffer_ref *vb, dpmatrix *m, float alpha, dpmatrix *m_world, float r, float g, float b )
    {
        return 1;
    }
