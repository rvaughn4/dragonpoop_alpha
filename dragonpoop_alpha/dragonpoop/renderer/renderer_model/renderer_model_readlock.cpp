...
namespace dragonpoop
{
    ...
    //render model
    void renderer_model_readlock::render( dpthread_lock *thd, dpposition *campos, dpheight_cache_readlock *heights, dpmatrix *m_world, render_api_context_writelock *ctx, render_api_commandlist_writelock *clist )
    {
        this->t->render( thd, campos, this, heights, m_world, ctx, clist );
    }
