...
namespace dragonpoop
{
    ...
    bool dpthread_singletask::hasStaticTask( void )
    {
        return 1;
    }

    //returns usage
    float dpthread_singletask::getUsage( void )
    {
        return 0.5f;
    }

    //removes a dynamic task
    dptask_ref *dpthread_singletask::getTask( void )
    {
        return 0;
    }

    //returns task count
    unsigned int dpthread_singletask::countTasks( void )
    {
        return 1;
    }
